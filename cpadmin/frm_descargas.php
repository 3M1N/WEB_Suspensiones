...
$xcrud->change_type('listaprecios','select','Cliente general','Cliente general, Cliente 1,Cliente 2,Cliente 3,Cliente 4, Cliente 5');
$xcrud->label('listaprecios', 'Cliente');
