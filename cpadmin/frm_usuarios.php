...
$xcrud->primary('idusuario');
$xcrud->columns('nombre,correo, idperfil');
$xcrud->order_by('nombre','asc');
$xcrud->table_name('Modulo de administradores del sistema');

$xcrud->relation('idperfil','perfilesusuarios','idperfil','perfil','');
//Campos obligatorios
