<?php /** f0ska xCRUD v.1.5.7.2 04/2013 */
...
-->
    ...
    protected function render_search($column, $phrase)
    {
        ...
        if (($this->field_type[$column] == 'date' or $this->field_type[$column] == 'datetime' or $this->field_type[$column] ==
            'timestamp'))
        {
    ...
    {
        $value = date('Y-m-d H:i:s', intval(preg_replace('/[^0-9]+/', '', $value) == $value ? $value : strtotime($value)));
    }
