...
class Xcrud_config{
    // default connection
    /*
    public static $dbname = 'dbsuspensiones';  // Your database name
    ...
    */
    ...
    public static $dbname = 'suspensiones';  // Your database name
    public static $dbuser = 'susp123';  // Your database username
    public static $dbpass = '123susp';  // // Your database password
    public static $dbhost = 'xe1uca1.ipowermysql.com';
    ...
    // xcrud folder url
    //public static $scripts_url = 'http://localhost/www.suspensiones.mx/cpadmin/xcrud'; // URL to the xCRUD folder, not real path, without a trailing slash, can be relative, e.g. 'some_folder/xcrud' or absolute, e.g. 'http://www.your_site.com/some_folder/xcrud'
    public static $scripts_url = 'http://www.suspensiones.com.mx/cpadmin/xcrud/';
    ...
    public static $tinymce_folder_url = ''; // URL path to TinyMCE, if you want to use the visual editor. TinyMCE is not included in xCRUD.
    public static $tinymce_init_url = ''; //  URL path to your custom initialization file for TinyMCE.
    ...
    public static $disable_jquery = false; // Disables loading of jQuery, turn it on if you already have jQuery on your page  by version at least 1.7
